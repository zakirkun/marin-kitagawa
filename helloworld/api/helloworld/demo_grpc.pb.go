...
const (
	Demo_CreateDemo_FullMethodName = "/api.helloworld.Demo/CreateDemo"
	Demo_UpdateDemo_FullMethodName = "/api.helloworld.Demo/UpdateDemo"
	Demo_DeleteDemo_FullMethodName = "/api.helloworld.Demo/DeleteDemo"
	Demo_GetDemo_FullMethodName    = "/api.helloworld.Demo/GetDemo"
	Demo_ListDemo_FullMethodName   = "/api.helloworld.Demo/ListDemo"
)
